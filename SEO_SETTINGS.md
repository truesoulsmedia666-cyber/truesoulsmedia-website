# True Souls Media LLP - Website Status & Settings

## 1. Website & Deployment
- **Domain**: `https://truesoulsmedia.com`
- **Hosting**: Cloudflare Pages
- **Version Control**: GitHub (`truesoulsmedia666-cyber/truesoulsmedia-website`)
- **Deployment**: Automatic deployment is triggered upon pushing to the `main` branch.
